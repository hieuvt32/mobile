...
class DetailReportView extends StatefulWidget {
  @override
  _DetailReportViewState createState() => _DetailReportViewState();
}

class _DetailReportViewState extends State<DetailReportView> {
  @override
...
class _DetailItemViewState extends State<DetailItemView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Oxi lỏng - Bình thép 15L"),
      ),
      body: Container(),
    );
  }
