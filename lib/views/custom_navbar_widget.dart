...
class CustomPersistentTabView extends CustomPersistentTabViewBase {
  ...
  CustomPersistentTabView(this.context,
      {Key? key,
  ...
  CustomPersistentTabView.custom(
    this.context, {
    Key? key,
    required this.screens,
    this.controller,
...
class CustomPersistentTabViewBase extends StatefulWidget {
  ...
  const CustomPersistentTabViewBase({
    Key? key,
    this.screens,
    this.controller,
    this.floatingActionButton,
  ...
  @override
  _CustomPersistentTabViewState createState() =>
